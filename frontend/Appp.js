...
const router = createBrowserRouter([
    {
        ...
        children :[
            ...
            { path : '/sysdesign', element: <SysDesign />,
                loader : async () => {
                    const response = await fetch('http://localhost:8080/sysdesign');
            ...
            { path : '/basicalgos', element: <BasicAlgos />,
                loader : async () => {
                    const response = await fetch('http://localhost:8080/basicalgos');
            ...
            { path : '/javabasic', element: <JavaBasic />,
                loader : async () => {
                    const response = await fetch('http://localhost:8080/basicjava');
