...
@Configuration
public class JavaBasicRepository extends TetelRepository{

    public JavaBasicRepository() throws ParserConfigurationException, SAXException, FileNotFoundException,Exception {
